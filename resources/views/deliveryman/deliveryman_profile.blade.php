    ...
    <div class="row pt-5">
        ...
        <div class="col-sm-10" style="margin-top: 4%">
            ...
            <div class="container-fluid">
                <center><h1>Profile Deliveryman</h1></center>
                <hr>            
             ...
             @endif
                ...
                <div class="templatemo-content-widget white-bg">
                    ...
                    <p class=" text-uppercase">Address : <span>{{$user->deliveryman->address}}</span>  </p>
                    <p class=" text-uppercase">Tel : <span>{{$user->deliveryman->tel}}</span>  </p>
                    <hr>
                    <p class=" text-uppercase">Vehicle : <span>{{$user->deliveryman->vehicle}}</span></p>
                    <hr>

                    <center> <a href="{{route('update_D')}}" class="btn btn-success">Updade</a> </center>
