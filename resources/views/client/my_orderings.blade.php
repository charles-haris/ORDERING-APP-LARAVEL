        ...
        <div class="col-sm-10" style="margin-top: 4%">
            ...
            @forelse( $products as $product )
                ...
                <div class="templatemo-content-widget white-bg">
                    <center><h2 class="margin-bottom-10">Product - {{$product->type_product}} </h2></center>
                    <hr>
            ...
            @empty
                <div class="templatemo-content-widget white-bg">
                    <center><h2 class="margin-bottom-10">My History</h2></center>
                    <hr>
                    <p class="text-center text-uppercase">You have no order</p>
                    <center><a href="{{route('order')}}"><button class="templatemo-edit-btn">New Order</button></a></center> 
                    <hr>
